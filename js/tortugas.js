class Tortugas {
  ...
  Mostrar() {
    ...
    textAlign(CENTER);
    fill(255);
    image(this.tortuguita, X(1700), Y(200) - transicion, X(150), Y(290));
    image(this.Lora, this.xLora, Y(580) - transicion, X(165), Y(290));
    image(this.Carey, this.xCarey, Y(580) - transicion, X(165), Y(290));
    image(this.Verde, this.xVerde, Y(580) - transicion, X(165), Y(290));
    image(this.Laud, this.xLaud, Y(580) - transicion, X(165), Y(290));
    image(this.Boba, this.xBoba, Y(580) - transicion, X(165), Y(290));
    image(this.Golfina, this.xGolfina , Y(580) - transicion, X(165), Y(290));

if(cambiarPantalla == false){
    image(this.btn_sgte, X(width / 2 + 121), Y(1080 - 98) - transicion, X(121), Y(98)); //BOTON SIGUIENTE
  }

    push();
    fill(255);
    text("Tortuga Lora", this.xLora, Y(780) - transicion);
    text("Tortuga Carey", this.xCarey, Y(780)- transicion);
    text("Tortuga Verde", this.xVerde, Y(780)- transicion);
    text("Tortuga Laud", this.xLaud, Y(780)- transicion);
    text("Tortuga Boba", this.xBoba, Y(780)- transicion);
    text("Tortuga Golfina", this.xGolfina, Y(780)- transicion);

    fill(221, 100, 84);
    text("Peligro critico", this.xLora, Y(815)- transicion);
    text("Peligro critico", this.xCarey, Y(815)- transicion);
    fill(221, 133, 84);
    text("En peligro", this.xVerde, Y(815)- transicion);
    fill(221, 207, 84);
    text("Vulnerable", this.xLaud, Y(815)- transicion);
    text("Vulnerable", this.xBoba, Y(815)- transicion);
    text("Vulnerable", this.xGolfina, Y(815)- transicion);
    pop();
  }
 ...
 //----------DIALOGO TORTUGAS------------
  DialogoTortugas() {
    ...
    if (dialogo == "dialogoTortugas1" && contDialogo <= 300 && transicion >= 0) {
      Dialogo(
    ...
    if (
      (dialogo == "dialogoTortugas2" && contDialogo <= 300 && agarre < 4) ||
      (dialogo == "dialogoTortugas2" && contDialogo <= 300 && agarre > 4)
    ) {
      Dialogo(
 ...
 //----------ABRIR SLIDER------------
  ...
  Slider(imagen_, porcentaje_, posX_, foto_, nombre_, cantidad_, peso_) {
    ...
    text("Puntos de mayor anidacion ", this.posX + 500, 538); //Peso
    image(this.punto, this.posX + 400, 534, 20, 20);
