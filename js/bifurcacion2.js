class Bifurcacion2 {
  ...
  Dibujar(){
    ...
    image(this.btn_tortu, this.xBtn_tortu,this.yBtn_tortu - transicion, X(204), Y(245));
    image(this.btn_ba, this.xBtn_ba,this.yBtn_ba - transicion, X(204), Y(245));

    image(this.coral1, this.xCoral1,this.yCoral1 - transicion, X(387), Y(223));
    image(this.coral2, this.xCoral2,this.yCoral2 - transicion, X(335), Y(302));
