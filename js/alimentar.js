...
background(226, 214, 104);
  ...
  Dibujar() {
    ...
    this.Bolsa(this.xBolsa1, this.yBolsa1 - transicion, 1);
    this.Bolsa(this.xBolsa2, this.yBolsa2 - transicion, 2);
    this.Bolsa(this.xBolsa3, this.yBolsa3 - transicion, 3);
    this.Bolsa(this.xBolsa4, this.yBolsa4 - transicion, 4);

    this.Medusa(this.xMedusa1, this.yMedusa1 - transicion);
    this.Medusa(this.xMedusa2, this.yMedusa2 - transicion);
    this.Medusa(this.xMedusa3, this.yMedusa3 - transicion);
    this.Medusa(this.xMedusa4, this.yMedusa4 - transicion);

    this.Particulas(this.xParticula1, this.yParticula1 - transicion);
    this.Particulas(this.xParticula2, this.yParticula2 - transicion);
    this.Particulas(this.xParticula3, this.yParticula3 - transicion);
  ...
  Grafico() {
    ...
    noStroke();
    fill(226, 214, 104);
    ellipse(displayWidth / 2, displayHeight / 2 - transicion, 350, 350);

    fill(221, 100, 84);
    arc(displayWidth / 2, displayHeight / 2  - transicion, 350, 350, -90, this.x);
    this.x += this.cantidad;

    fill(22, 85, 104);
    ellipse(displayWidth / 2, displayHeight / 2  - transicion, 300, 300);
    pop();
    ...
    textFont(tipografia);
    textAlign(CENTER);
    text("Vida " + this.vida + "%", displayWidth / 2, 640 - transicion);
    pop();
    pop();
  }
  ...
  DialogoAlimentar() {
    ...
    if (dialogo == "dialogoAlimentar1" && contDialogo <= 300 && transicion >= 0) {
      Dialogo(
    ...
    if(this.vida == 50 && this.cont == 0 && this.sumar == false){
      Dialogo(
        "Cuidado! Si ingerimos 14 pedazos \n de plastico nuestra vida \n se reduce un 50%",
        X(displayWidth / 2 + X(380)),
        Y(380),
        X(370),
        Y(210),
        X(displayWidth / 2 + X(230)),
        Y(350)
      );
    }

    if( this.m == 3 &&  this.cont == 0 && this.sumar == true){
      Dialogo(
        "Sabias que? \n las tortugas somos inmunes \n al veneno de las medusas!",
        X(displayWidth / 2 + X(380)),
        Y(380),
        X(370),
        Y(210),
