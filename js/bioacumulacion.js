class Bioacumulacion {
  ...
  Dibujar(){
    ...
    fill(255);
    textAlign(CENTER)
    text("Hablemos de la Bioacumulación", displayWidth / 2, 100 - transicion);

    pop();

    image(this.btn_plastico, this.xBtn_p1,this.yBtn_p1 - transicion, X(204), Y(245));
    image(this.btn_animales, this.xBtn_p2,this.yBtn_p2 - transicion, X(204), Y(245));
    image(this.btn_alimentos, this.xBtn_p3,this.yBtn_p3 - transicion, X(204), Y(245));

    image(this.tortuga, this.xTortu,this.yTortu - transicion, X(200), Y(214));
    textSize(14);
